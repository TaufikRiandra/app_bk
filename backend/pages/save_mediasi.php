        ...
        if (isset($item['id_mediasi']) && $item['id_mediasi'] > 0) {
            ...
            $query = "INSERT INTO layanan_mediasi 
                      (tanggal, id_guru_bk, nama_pihak_1, kelas_pihak_1, masalah_pihak_1, 
                       nama_pihak_2, kelas_pihak_2, masalah_pihak_2, hasil_mediasi, keterangan)
                      VALUES ('$tanggal', $id_guru_bk, '$nama_pihak_1', '$kelas_pihak_1', '$masalah_pihak_1',
                              '$nama_pihak_2', '$kelas_pihak_2', '$masalah_pihak_2', '$hasil_mediasi', '$keterangan')";
        }
...
if ($action === 'save') {
    ...
    $query = "DELETE FROM layanan_mediasi WHERE id_mediasi = $id_mediasi";
