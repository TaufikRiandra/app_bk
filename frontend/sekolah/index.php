...
<section class="card">
					...
					<tr>
						...
						<td style="text-align:center">
							<?php if(isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
								...
								<a href="../../backend/sekolah/delete.php?id=<?= $r['id_sekolah'] ?>" onclick="return confirm('Yakin hapus data ini?')" style="color:#ef4444;text-decoration:none;font-weight:500;transition:all 0.3s" onmouseover="this.style.textDecoration='underline'" onmouseout="this.style.textDecoration='none'">🗑️ Hapus</a>
							<?php else: ?>
	...
	<?php else: ?>
		<div style="text-align:center;padding:2rem;background:rgba(37,99,235,0.04);border-radius:8px">
			...
			<a href="./tambah.php" class="btn">➕ Tambah Sekolah</a>
		</div>
	<?php endif; ?>
</section>
