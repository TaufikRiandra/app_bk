...
<section class="card">
	<div style="margin-bottom:2rem">
		<h1 style="margin-bottom:0.25rem;font-size:1.75rem">📋 Input Layanan Manual</h1>
	...
	<div style="display:grid;grid-template-columns:250px 1fr;gap:2rem;align-items:start">
		...
		<div style="background:var(--bg-light);padding:1.5rem;border-radius:8px;border:1px solid var(--border);height:fit-content;sticky;top:2rem">
				...
				<div style="background:var(--surface);padding:2rem;border-radius:8px;border:1px solid var(--border)">
					...
					<div style="padding:1.5rem;background:var(--bg-light);border-radius:6px;border-left:4px solid var(--brand);margin-bottom:2rem">
						<p style="color:var(--text-light);margin:0">
							✓ Halaman input untuk layanan <strong><?= htmlspecialchars($selected_layanan['nama_layanan']) ?></strong> akan segera disediakan.
						</p>
					</div>
