...
<section class="card" style="max-width:600px;margin:0 auto">
	<div style="margin-bottom:2rem">
		<h1 style="margin-bottom:0.25rem;font-size:1.75rem"><i class="fas fa-user-plus"></i> Tambah Guru BK</h1>
	...
	<form action="../../../backend/sekolah/guru_bk/create.php" method="POST" enctype="multipart/form-data">
		...
		<div style="margin-top:2rem;display:flex;gap:1rem;flex-wrap:wrap">
			<button type="submit" class="btn btn-success"><i class="fas fa-check"></i> Simpan Guru BK</button>
