					...
					?>
						<tr style="border-bottom:1px solid var(--border);transition:all 0.3s" onmouseover="this.style.background='var(--bg-light)'" onmouseout="this.style.background='transparent'">
							...
							<td style="padding:1rem">
								...
								<?php else: ?>
												<div style="width:40px;height:40px;background:linear-gradient(135deg, var(--primary), var(--primary-dark));border-radius:50%;display:flex;align-items:center;justify-content:center;color:white;font-size:1.5rem"><i class="fas fa-user-tie"></i></div>
								<?php endif; ?>
							</td>
							<td style="padding:1rem">
